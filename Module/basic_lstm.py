...
class TwoLayerLSTM_trial(nn.Module):
    def __init__(self, input_size, hidden_size, num_states, num_layers, use_bottleneck, drop_out=0.2, bottleneck_width=256):
        super().__init__()
        self.lstm = nn.LSTM(input_size, hidden_size, num_layers=num_layers, dropout=drop_out)
